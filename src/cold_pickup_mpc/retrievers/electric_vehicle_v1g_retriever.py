    ...
    def _load_dynamic_data(self, start: datetime, stop: datetime) -> Dict[str, Any]:
        ...
        for device in self._devices:
            ...
            soc_preferences[entity_id] = get_preferences_data(
                preferences_type="vehicle-soc-preferences",
                device_id=entity_id,
                start=start,
                stop=stop,
            )

            branched_preferences[entity_id] = get_preferences_data(
                preferences_type="vehicle-branched-preferences",
                device_id=entity_id,
                start=start,
                stop=stop,
            )
        ...
        data["branched_preferences"] = branched_preferences
